...
<div class="super_container">
	...
	<header class="header">
		<div class="col-md-12" align="center">
		  ...
		  <div class="card--content"><img src="{{asset('images/aaa.jpg')}}" alt="" style="width: 100%"></div>
			...
			<div class="container">
				<div class="row">
					<div class="col d-flex flex-row" >
						<div class="top_bar_contact_item"><div class="top_bar_icon"><img src="asset/image/phone_white.png" alt=""></div>+852-94169123</div>
						<div class="top_bar_contact_item"><div class="top_bar_icon"><img src="{{asset('asset/image/mail_white.png')}}" alt=""></div><a href="mailto:Nshisnepal@gmail.com">Nshisnepal@gmail.com </a></div>
						<div class="top_bar_content ml-auto">
							
							<div class="top_bar_user">
								<div class="user_icon"><img src="{{asset('asset/image/user.png')}}" alt="user"></div>
								<div><a href="{{asset('customerLogin')}}">Login</a> | <a href="{{asset('/customerRegister')}}">  Register </a></div>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="header_main" >
			<div class="container">
				<div class="row">
					...
					<!-- Logo -->
					<div class="col-lg-2 col-sm-3 col-4 order-1">
							...
							<div class="cart">
								<div class="cart_container d-flex flex-row align-items-center justify-content-end">
									...
									<div class="cart_content">
										<div class="cart_text"><a href="{{asset('shopping_cart')}}">Cart
						...
						<div class="main_nav_content d-flex flex-row">
							...
							<div class="main_nav_menu ml-auto">
								<ul class="standard_dropdown main_nav_dropdown">
									...
									<!-- <li><a href="{{asset('/blogs')}}">Certified Student<i class="fas fa-chevron-down"></i></a></li> -->
									<!-- <li><a href="{{asset('/service')}}">Service<i class="fas fa-chevron-down"></i></a></li> -->
					...
					<div class="col">
						...
						<div class="page_menu_content">
							...
							<ul class="page_menu_nav">
								...
								<li class="page_menu_item"><a href="Service.php">Service<i class="fa fa-angle-down"></i></a></li
								<li>
								 <div class="btn-group">
					                    <a data-toggle="dropdown" style="color: #fff; cursor: pointer;"> 
					                        My Account
					                    ...
					                    <div class="dropdown-menu">
					                        <a class="dropdown-item " style="color: black;" href="AccountDetails.php">My Account</a>
					                        <a class="dropdown-item" style="color: black;" href="../userAction/logout.php">Log Out</a>
					                    </div>
					                 </div> 
					            </li>
							</ul>
							...
							<div class="menu_contact">
								<div class="menu_contact_item"><div class="menu_contact_icon"><img src="{{asset('asset/image/phone_white.png')}}" alt=""></div>+977-9801071676</div>
