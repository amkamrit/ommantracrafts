  ...
  <main class="page payment-page">
    ...
    <section class="payment-form dark">
      <div class="container">
        ...
        <form action="{{route('checkoutM')}}" method="post" id="checkout-form">
          <div class="products">
            {{csrf_field()}}
          ...
          <div class="card-details">
            @foreach($cardInfo as $cardInfos)
            <h3 class="title" hidden>Payment
            </h3>
            <div class="row">
              <div class="form-group col-sm-7">
                <label for="card-holder" hidden>Card Holder</label>
                <input id="card-holder" type="text" class="form-control" placeholder="Card Holder" aria-label="Card Holder" aria-describedby="basic-addon1" value="{{$cardInfos->acccount_name}}" required hidden >
              </div>
              <div class="form-group col-sm-5">
                <label for=""  hidden>Expiration Date</label>
                <div class="input-group expiration-date">
                  <input type="text" class="form-control" placeholder="MM" aria-label="MM" aria-describedby="basic-addon1" id="card-expiry-month"  required hidden>
                  <span class="date-separator" hidden>/</span>
                  <input type="text" class="form-control" placeholder="YY" aria-label="YY" aria-describedby="basic-addon1" id="card-expiry-year" required hidden>
                </div>
              </div>
              <div class="form-group col-sm-8">
                <label for="card-number" hidden>Card Number</label>
                <input type="text" class="form-control" placeholder="Card Number" aria-label="Card Holder" aria-describedby="basic-addon1" id="card-number" value="{{$cardInfos->card_number}}" required hidden>
              </div>
              <div class="form-group col-sm-4">
                <label for="cvc" hidden>CVC</label>
                <input type="text" class="form-control" placeholder="CVC" aria-label="Card Holder" aria-describedby="basic-addon1" id="card-cvc" value="{{$cardInfos->cvc_number}}" required hidden>
              </div>
              
              <div class="form-group col-sm-12">
                <button type="submit" class="primary-btn btn-block" > Pay</button>
              </div>
             <!--  <div class="form-group col-sm-6">
...
@else
  <!-- start if the section not variable is present-->
  </style>
            ...
            <div class="col-md-6 col-12" style="border-left:solid lightgrey 1px;">
                <div class="contact_info " style="margin-top: 13%;">
                    ...
                    <div class="form-group text-center">
                        <a href="./register.php" class="primary-btn">Register Here</a>
                    </div>
                </div>
            </div>
        </div>
          ...
          <div class="card-details">
            ...
            <div class="row">
              ...
              <div class="form-group col-sm-5">
                ...
                <div class="input-group expiration-date">
                  <input type="text" class="form-control" placeholder="MM" aria-label="MM" aria-describedby="basic-addon1" id="card-expiry-month"  required>
                  <span class="date-separator">/</span>
                  <input type="text" class="form-control" placeholder="YY" aria-label="YY" aria-describedby="basic-addon1" id="card-expiry-year" required>
                </div>
              </div>
              <div class="form-group col-sm-8">
                <label for="card-number">Card Number</label>
                <input type="text" class="form-control" placeholder="Card Number" aria-label="Card Holder" aria-describedby="basic-addon1" id="card-number" required>
              </div>
              <div class="form-group col-sm-4">
                <label for="cvc">CVC</label>
                <input type="text" class="form-control" placeholder="CVC" aria-label="Card Holder" aria-describedby="basic-addon1" id="card-cvc" required>
              </div>
